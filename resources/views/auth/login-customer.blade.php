...
<head>
  ...
  <title>Login Customer – PT Nusantara Digital Express</title>
  ...
  <div class="auth-layout">
    ...
    <div class="auth-left">
      <div class="auth-left-content">
        ...
        <div class="auth-welcome">
          ...
          <p>Masuk ke akun Anda untuk mengakses layanan peminjaman barang perusahaan secara mudah, cepat, dan transparan.</p>
        </div>
        <div class="auth-illustration">
          <div class="ill-card">
            ...
            <div style="margin-top:14px;padding-top:14px;border-top:1px solid var(--gray-100)">
              <div style="font-size:11px;color:var(--gray-500);margin-bottom:8px">Layanan Digital Terpadu</div>
              <div style="display:flex;gap:8px;flex-wrap:wrap">
                <span class="badge badge-success">Katalog Online</span>
                <span class="badge badge-info">Tracking Real-time</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="auth-right">
      <div class="auth-form-box">
        ...
        @if($errors->any())
          <div class="info-alert red" style="margin-bottom: 16px; border-radius: 10px; line-height: 1.5;">
            {{ $errors->first() }}
          </div>
        @endif
        ...
        <form class="auth-form" method="POST" action="{{ route('login.post') }}">
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <input type="email" name="email" class="form-input" placeholder="email@example.com" value="{{ old('email', 'budi@example.com') }}" required autofocus/>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <input type="password" name="password" class="form-input" placeholder="Masukkan password" value="password" id="cust-pass" required/>
              <button type="button" class="input-icon-right" onclick="togglePass('cust-pass')">
        ...
        <a href="{{ route('admin.login') }}" class="btn btn-outline btn-full">Login sebagai Admin</a>
